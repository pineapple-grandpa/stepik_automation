...
class CookieIssueDetails:
    ...
    def from_json(cls, json):
        return cls(
            ...
            if "rawCookieLine" in json
            else None,
            site_for_cookies=str(json["siteForCookies"])
            if "siteForCookies" in json
            else None,
...
class TrustedWebActivityIssueDetails:
    ...
    def from_json(cls, json):
        return cls(
            url=str(json["url"]),
            violation_type=TwaQualityEnforcementViolationType.from_json(
                json["violationType"]
            ),
...
class AttributionReportingIssueType(enum.Enum):
    ...
    ATTRIBUTION_EVENT_SOURCE_TRIGGER_DATA_TOO_LARGE = (
...
class InspectorIssueDetails:
    ...
    twa_quality_enforcement_details: typing.Optional[
    ...
    def to_json(self):
        ...
        if self.twa_quality_enforcement_details is not None:
            ...
            ] = self.twa_quality_enforcement_details.to_json()
