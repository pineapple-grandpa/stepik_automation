...
class DOMNode:
    ...
    def from_json(cls, json):
        return cls(
            ...
            if "contentLanguage" in json
            else None,
            document_encoding=str(json["documentEncoding"])
            if "documentEncoding" in json
            else None,
            ...
            if "scrollOffsetX" in json
            else None,
            scroll_offset_y=float(json["scrollOffsetY"])
            if "scrollOffsetY" in json
            else None,
        )
...
class DocumentSnapshot:
    ...
    def from_json(cls, json):
        return cls(
            ...
            if "contentWidth" in json
            else None,
            content_height=float(json["contentHeight"])
            if "contentHeight" in json
            else None,
        )
